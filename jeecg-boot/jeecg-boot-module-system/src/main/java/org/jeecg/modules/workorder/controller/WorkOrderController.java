...
public class WorkOrderController extends JeecgController<WorkOrder, IWorkOrderService> {
	 ...
	 * @return
	 */
	@AutoLog(value = "work_order-分页列表查询")
	@ApiOperation(value="work_order-分页列表查询", notes="work_order-分页列表查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "work_order-添加")
	@ApiOperation(value="work_order-添加", notes="work_order-添加")
	 ...
	 * @return
	 */
	@AutoLog(value = "work_order-编辑")
	@ApiOperation(value="work_order-编辑", notes="work_order-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "work_order-通过id删除")
	@ApiOperation(value="work_order-通过id删除", notes="work_order-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "work_order-批量删除")
	@ApiOperation(value="work_order-批量删除", notes="work_order-批量删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "work_order-通过id查询")
	@ApiOperation(value="work_order-通过id查询", notes="work_order-通过id查询")
    ...
    */
    ...
    public ModelAndView exportXls(HttpServletRequest request, WorkOrder workOrder) {
        return super.exportXls(request, workOrder, WorkOrder.class, "work_order");
    }
