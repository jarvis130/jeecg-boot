<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('goods_sku')">导出</a-button>
    ...
    <goods-sku-modal ref="modalForm" @ok="modalFormOk"></goods-sku-modal>
  </a-card>
</template>
